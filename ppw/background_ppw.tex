...
$I_{leak}$ is composed of many components, including subthreshold current, gate current, reverse-biased junction leakage current, et cetera. During which, subthreshold current and gate current are the main parts of leakage current.
