...
\begin{figure}
  ...
  %   }
  \caption{Temperature distributions of a 9-core system with 5 cores active in different power budget.}
  \label{fig:opt_tem}
\end{figure}
...
Considering to solve optimization problem in \eqref{eq:opt_ppw}, 
