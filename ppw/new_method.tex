...
\begin{figure}
  \centering
  \subfigure[$3$ ways to improve the temperature to $T_{opt}$.]{
    \includegraphics[width=0.47\columnwidth]{fig/ppw_1_1.eps}\label{fig:ppw_1_1}
  }
  \subfigure[The corresponding PPW curves of improving temperatures.]{
    \includegraphics[width=0.47\columnwidth]{fig/ppw_1_3.eps}\label{fig:ppw_1_3}
  }
  \subfigure[$3$ ways to decrease the temperature to $T_{opt}$.]{
    \includegraphics[width=0.47\columnwidth]{fig/ppw_2_1.eps}\label{fig:ppw_2_1}
  }
  \subfigure[The corresponding PPW curves of decreasing temperatures.]{
    \includegraphics[width=0.47\columnwidth]{fig/ppw_2_3.eps}\label{fig:ppw_2_3}
    }
...
As Fig.~\ref{fig:ppw_1_1} shows, for different frequency, the temperature by the end of the control interval will be different. For $f_{1}$, $T(t+h)$ will be higher than $T_{opt}$, $f_{2}$ will lead to $T_{opt}$ in $t+h$, and for $f_{3}$, $T_{t+h}$ will be lower than $T_{opt}$.
