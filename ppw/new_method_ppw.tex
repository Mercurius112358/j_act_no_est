...
If we only set one Taylor expansion temperature point, considering that there are two possible states for light cores, active state and idle state, and the temperature difference between the two states can be 
