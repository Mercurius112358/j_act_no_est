...
\subsection{Amdahl's law extension}
With thermal constraint considered, it's not common for cores to run at full voltage and frequency
...
\subsection{Greedy search static based acceleration of power estimation}
